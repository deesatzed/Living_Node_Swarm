...
| Q6-04 | Remove/hard-gate bulk activation semantics | Q3-07, Q6-02 | invalid/unreviewed batch cannot activate | In progress — the Gas UI no longer exposes direct single-node or bulk activation/wiring callbacks; disabled controls explain that proposed factors require separately reviewed, exact-bound approval in the shared workspace. Static source scan finds no `activateOne(`, `activateAll(`, or enabled auto-activation request in the Gas UI; shared-workspace preset migration remains. (gas build, 2026-07-28) |
