...
| Q6-02 | Replace duplicate gas UI with shared workspace preset | Q4-10, Q6-01 | gas app uses shared components | In progress — the Gas preset now mounts the shared `WorkspaceShell` around its domain-specific controls, reusing the canonical project header, lifecycle rail, context-inspector prompt, and analysis tray as well as shared stage definitions. Its internal gas graph/simulation controls remain preset-specific while full shared graph/inspector migration remains. (gas build, 2026-07-28) |
