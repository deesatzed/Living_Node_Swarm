...
| Q4-07 | Build active-vs-candidate and model/ensemble comparison | Q3-06, Q4-01 | paths and distribution changes visible; explicit two-model weighted ensemble is backend-owned and no false improvement label appears | In progress — Edit exposes a graph-derived, one-parameter in-memory active-vs-candidate comparison with paired summaries and no-improvement limitation; persisted candidate revisions, affected-path explanation, and model/ensemble comparison remain (2026-07-28) |
