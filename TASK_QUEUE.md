...
| Q4-06 | Build evidence drawer and warning center | Q2-03, Q4-01 | claims/conflicts/unknowns trace to nodes | In progress — canonical Vet can load/review claims with source/conflict context and Map shows fixture limitations. In Edit, the evidence drawer defaults to IDs linked by persisted node distribution specifications and active relationship contracts, then narrows to a selected graph factor’s linked claims without resetting its draft controls; unrelated target claims are excluded. Relationship selection-level traceability and live source capture remain (124 shared tests; 8 fixture E2E tests, 2026-07-28) |
