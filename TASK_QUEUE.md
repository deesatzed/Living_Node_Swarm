...
| Q4-06 | Build evidence drawer and warning center | Q2-03, Q4-01 | claims/conflicts/unknowns trace to nodes | In progress — canonical Vet can load/review claims with source/conflict context and Map shows fixture limitations. In Edit, the evidence drawer now filters the target review to IDs linked by persisted node distribution specifications and active relationship contracts, excluding unrelated target claims; graph selection-level traceability and live source capture remain (124 shared tests; 8 fixture E2E tests, 2026-07-28) |
