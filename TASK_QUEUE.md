...
| Q6-04 | Remove/hard-gate bulk activation semantics | Q3-07, Q6-02 | invalid/unreviewed batch cannot activate | In progress — the Gas UI no longer exposes a bulk activation/wiring callback; its disabled control explains that proposed factors must be separately reviewed and exact-bound in the shared workspace. Static source scan finds no `activateAll(` or enabled auto-activation request in the Gas UI; shared-workspace preset migration remains. (gas build, 2026-07-28) |
