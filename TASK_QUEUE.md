...
| Q4-05 | Build relationship inspector | Q3-05, Q4-01 | type, units, lag, evidence, state editable/reviewable | In progress — draft-only reusable inspector exposes complete relationship semantics and warnings. A proposed kernel `RelationshipContract` now persists in an exact version-bound candidate revision after active-graph node validation, without activation, simulation, or approval; canonical inspector-to-revision integration remains (68 server tests, 2026-07-28) |
