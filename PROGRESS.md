...
| Idea/Vet component foundation | In progress | Codex | Accessible target form distinguishes the Neodymium private-investor retail series, blocks incomplete contracts, collects every authoritative target-contract field with timezone-aware submission values, and has a reusable project-persistence wrapper that reports success/failure without attaching a failed target. In canonical Vet, Pause/Resume works, action-specific discovery entries persist as typed project-ledger records, and Proceed now advances without granting research/provider consent (53 shared tests, shared type build, canonical production build, 2026-07-28). Complete consent receipts, research brief categories, and live research remain. |
