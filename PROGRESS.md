...
| Idea/Vet component foundation | In progress | Codex | Accessible target form distinguishes the Neodymium private-investor retail series, blocks incomplete contracts, collects every authoritative target-contract field with timezone-aware submission values, and has a reusable project-persistence wrapper that reports success/failure without attaching a failed target. The canonical Build route now proceeds to Vet, where classified facts/user claims/inferences/scenarios/unknowns persist through the project discovery ledger; Proceed now advances without granting research/provider consent (41 shared tests, shared type build, canonical production build, 2026-07-28). Complete consent receipts and live research remain. |
