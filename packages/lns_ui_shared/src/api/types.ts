...
export interface WorkspaceCandidateRevisionInput { id: string; base_graph_version: number; candidate_parameter_overrides?: Record<string, Record<string, number>>; candidate_distribution_specs?: Record<string, JsonObject>; candidate_node_state_overrides?: Record<string, "active" | "excluded">; candidate_relationship_state_overrides?: Record<string, "active" | "excluded">; candidate_relationship_contracts?: JsonObject[]; candidate_new_nodes?: JsonObject[]; }
