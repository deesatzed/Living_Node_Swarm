...
describe("ProjectWorkspaceRouter", () => {
  it("starts at Project Home and routes New to persisted-project creation", async () => {
    ...
    const client = {
      ...
      getTarget: vi.fn(), getProject: vi.fn(), createProject: vi.fn(), createTarget: vi.fn(), patchProject: vi.fn(), createFixtureCandidateProposal: vi.fn(), runSimulation: vi.fn(), getMonitoring: vi.fn(), saveMonitoring: vi.fn(), acknowledgeMonitoringEvent: vi.fn(), createDraft: vi.fn(), createScenario: vi.fn(), listScenarios: vi.fn(),
    };
