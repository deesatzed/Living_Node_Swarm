...
| [P12] Existing-model branch/edit/approve | Fixture-only | Canonical Monitor → Edit structural comparison/approval journey plus all six non-quantile derivation forms and Normal/Gamma provenance-bearing distribution proposals saved for exact review. | Distribution-spec final activation is server-tested; the fixture does not yet click its final approval or cover every stale-approval branch. |
