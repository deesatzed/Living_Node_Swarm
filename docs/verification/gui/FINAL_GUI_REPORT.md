...
| [P25] Regression surface | Locally verified | Kernel 86, server 89, shared UI 125, canonical Playwright 8, UI/gas builds, and `git diff --check` from this session. | Fresh command output is local, not CI. |
